...
import { CockpitSystemDomain } from './UniversalCockpitHUDModal';
...
export const FullscreenGraphButton: React.FC<FullscreenGraphButtonProps> = ({
  ...
  title = 'Развернуть график/анимацию во весь экран с интерактивным управлением',
}) => {
  const handleClick = (e: React.MouseEvent) => {
    ...
    if (onClick) {
      ...
      window.dispatchEvent(
        new CustomEvent('open-cockpit-hud', {
          detail: { domain, mach, alpha },
        })
      );
    }
  };
